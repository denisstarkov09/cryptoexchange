  ...
  return (
    ...
    >
      ...
      <Typography variant="caption" color="textSecondary">
        ...
        latency! This dashboard can be slow to update due to API rate limitations, and CryptoFun will not be liable
      ...
      <Box display="flex" justifyContent="space-between" paddingTop={3} paddingBottom={2}>
        <Button
          ...
          variant="contained"
          href='https://github.com/OleksandrKudash/crypto-exchange'
          target='_blank'
